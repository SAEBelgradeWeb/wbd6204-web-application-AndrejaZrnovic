                        ...
                        <div class="host-block mb-30">
                            <div class="host-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="message" rows="4" spellcheck="false"></textarea>
                                </div>
                                <label for="basic-url">Your picture URL</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon3">https://images.unsplash.com/photo</span>
                                    </div>
